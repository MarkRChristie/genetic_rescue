...
#Timing parameters
selection.start.year <- 25    # year that selection starts
selection.end.year   <- 125   # 150 is default when 50 is selection.start.year
...
optima                <- NA #phenotpyic optimum in new enviornment; here modeled as increase (celsius) in temp tolerance. so 2 would mean 2 degrees higher than current temp conditions. dictactes selection strength in each generation. linear.
